...
const WorldMap = () => {
    ...
    return (_jsxs("div", { className: "world-map", style: { marginLeft: '20px', flex: 1 }, children: [_jsx("h3", { style: { color: '#ff8c00', marginBottom: '10px' }, children: "World Reference Map" }), _jsxs("div", { className: "world-map__container", style: { position: 'relative', height: '400px', background: '#0a1929', borderRadius: '8px', overflow: 'hidden', border: '2px solid #ff8c00' }, children: [_jsxs("svg", { style: { position: 'absolute', width: '100%', height: '100%', top: 0, left: 0 }, children: [[-60, -30, 0, 30, 60].map(lat => {
                                const y = ((90 - lat) / 180) * 100;
                                return (_jsx("line", { x1: "0%", y1: `${y}%`, x2: "100%", y2: `${y}%`, stroke: "#334155", strokeWidth: "1" }, `lat-${lat}`));
                            }), [-120, -60, 0, 60, 120].map(lon => {
                                const x = ((lon + 180) / 360) * 100;
                                return (_jsx("line", { x1: `${x}%`, y1: "0%", x2: `${x}%`, y2: "100%", stroke: "#334155", strokeWidth: "1" }, `lon-${lon}`));
                        ...
                        return (_jsxs("div", { style: {
                            ...
                            }, title: city.name, children: [_jsx("div", { style: {
                                        width: '8px',
                                        height: '8px',
                                        borderRadius: '50%',
                                        background: '#ff8c00',
